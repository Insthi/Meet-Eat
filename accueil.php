...
session_start();
try {
    $pdo = new PDO("mysql:host=localhost;dbname=v2meet-eat;charset=utf8", "root", "root");
...
<body>
   ...
   <header class="navigation-principale">
    ...
    <a href="profil.php">
        <button class="bouton-icone-profil"><i class="fa-regular fa-user"></i></button>
    </a>
<?php else: ?>
    <a href="login.php">
        <button class="bouton-icone-profil"><i class="fa-regular fa-user"></i></button>
...
<?php endif; ?>
    ...
    <section class="pane love-pane">
        ...
        <div class="content">
            ...
            <p class="description-split">Choisir l’amour, c’est choisir les frissons et la tendresse. Prêts à fondre comme un chocolat et à faire frétiller les cœurs comme des bulles de champagne ?</p>
    ...
    <section class="pane friendship-pane">
        ...
        <div class="content">
            ...
            <p class="description-split">L’amitié se savoure comme un moment délicieux. Prêts à croquer la vie comme une part de pizza et à remplir les cœurs de joie ?</p>
    ...
    <div id="modaleCommentaire" class="superposition-modale">
        <div class="contenu-modale modale-feedback">
            ...
            <div class="logo-top-left">
                <img src="assets/logoinverse.png" alt="M">
            ...
            <div id="etapeSucces" style="display: none;">
                ...
                <a href="index-test.php" class="btn-beige-pill" style="text-decoration: none; display: inline-block; text-align: center;">
